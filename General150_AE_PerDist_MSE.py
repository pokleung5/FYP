...
train_id = '_'.join(['General150', 'AE', 'PerDist', 'MSE'])
...
lossFun = MultiLoss(lossFunList=[mseLoss])

preprocess = PrepPerDist(N)
...
param = [(N, L)  for L in range(2, 5) for N in range(72, 73, 16)]
