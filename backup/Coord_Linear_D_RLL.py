...
from lossFunction import CustomLoss, CoordsToDMLoss, ReconLoss, MultiLoss, sammon_loss, relative_loss
...
train_id = '_'.join(['Coord', 'Linear', 'D', 'RLL'])

coordLoss = CoordsToDMLoss(N, lossFun=relative_loss)
