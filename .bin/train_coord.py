...
for neuron in [32, 64, 96]:
    ...
    for i in range(2, 6):
        ...
        model_id = "Coord_Linear_" + str(i) + "_" + str(neuron) + "_distance_LReLU"
...
for neuron in [32, 64, 96]:
    ...
    for i in range(2, 6):
        ...
        model_id = "Coord_Linear_" + str(i) + "_" + str(neuron) + "_matrix_LReLU"
...
for neuron in [32]:
    ...
    for i in range(6, 12):
        ...
        model_id = "Coord_Linear_" + str(i) + "_" + str(neuron) + "_eign_LReLU"
